...
def open_search_panel(self):
    ...
    panel = tk.Frame(self.root, bg="white", width=340, relief="solid", bd=1)
    ...
    tk.Label(
        panel, text="Search", bg="white", fg="black", font=("Helvetica", 14, "bold")
    ).pack(pady=(0, 10))
    ...
    results_scroll = tk.Scrollbar(
        panel, orient="vertical", command=results_canvas.yview
    )
